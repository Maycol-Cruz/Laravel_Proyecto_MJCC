...
@section('contenido2')
                ...
                <div class="columns is-centered">
                    <div class="column is-half">
                        <form action="/categorias/{{$categoria->cat_id}}" method="POST">
                            @method('PUT')
                            @csrf
                            <div class="field">
                                <label class="" for="usr">NOMBRE DE CATEGORIA:</label>
                                <div class="control">
                                    <input class="input" type="text" value="{{old('cat_nombre', $categoria->cat_nombre)}}" name="cat_nombre" id="pro_nombre">
                                </div>
                                @error('cat_nombre')
                            ...
                            <div class="field">
                                ...
                                <div class="control">
                                    <textarea name="cat_descripcion" id="cat_descripcion" cols="30" rows="10">{{old('cat_descripcion', $categoria->cat_descripcion)}}</textarea>
                                </div>
